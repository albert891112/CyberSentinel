...
def load_phishtank_data(
    path: str = "data/Malicious_url/verified_online.csv", sample_size: int = 100000
) -> list[str] | None:
...
def load_kaggle_data(
    path: str = "data/malicious_phish.csv",
...
def load_fireeye_data(
    path: str = "data/fireeye_urls.csv",
) -> tuple[list[str], list[str]] | None:
